...
* You can pass intereret parameter to http://localhost:3000/api/v1/attendees in order to return results interleaved with interest and ordered by importance
